...
1. Transforme TOUS les tableaux au format JSON suivant:
   - Chaque tableau doit être converti en un objet JSON avec:
     * Une propriété "title" contenant "[CODE] - [NOM PRODUIT]"
     * Une propriété "headers" contenant un tableau des en-têtes de colonnes
     * Une propriété "data" contenant un tableau de lignes, chaque ligne étant un tableau de valeurs
   - Utilise null pour les valeurs manquantes (au lieu de tirets)
   - Exemple de transformation:
     ...
     {
       "title": "[CODE] - [NOM PRODUIT]",
       "headers": ["Colonne1", "Colonne2", "Colonne3"],
       "data": [
         ["ValeurA1", "ValeurA2", null],
         ["ValeurB1", null, "ValeurB3"]
       ]
     }
     -------
     ```
...
"""
        ...
        with client.messages.stream(
            ...
            tous les tableaux en format JSON. Pour chaque tableau, crée un objet JSON avec une propriété "title" 
            contenant "[CODE] - [NOM PRODUIT]", une propriété "headers" contenant un tableau des en-têtes de colonnes,
            et une propriété "data" contenant un tableau de lignes (chaque ligne étant un tableau de valeurs).
            Utilise null pour les valeurs manquantes au lieu de tirets. Assure-toi que l'objet JSON est correctement 
            formaté et indique le code et nom du produit au-dessus dans un format "Tableau [code produit] - [nom produit]".
